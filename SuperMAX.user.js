...
const CFG_DEFAULTS = {
  ...
  REGEX:{
    base:[
        ...
        { pattern: "\\.\\s*0?1\\.(2025|25)", flags: "gu", replacement: ". Januar" },
        { pattern: "\\.\\s*0?2\\.(2025|25)", flags: "gu", replacement: ". Februar" },
        { pattern: "\\.\\s*0?3\\.(2025|25)", flags: "gu", replacement: ". März" },
        { pattern: "\\.\\s*0?4\\.(2025|25)", flags: "gu", replacement: ". April" },
        { pattern: "\\.\\s*0?5\\.(2025|25)", flags: "gu", replacement: ". Mai" },
        { pattern: "\\.\\s*0?6\\.(2025|25)", flags: "gu", replacement: ". Juni" },
        { pattern: "\\.\\s*0?7\\.(2025|25)", flags: "gu", replacement: ". Juli" },
        { pattern: "\\.\\s*0?8\\.(2025|25)", flags: "gu", replacement: ". August" },
        { pattern: "\\.\\s*0?9\\.(2025|25)", flags: "gu", replacement: ". September" },
        { pattern: "\\.\\s*10\\.(2025|25)", flags: "gu", replacement: ". Oktober" },
        { pattern: "\\.\\s*11\\.(2025|25)", flags: "gu", replacement: ". November" },
        { pattern: "\\.\\s*12\\.(2025|25)", flags: "gu", replacement: ". Dezember" },
        { pattern: "\\.\\s*0?1\\.(2026|26)", flags: "gu", replacement: ". Januar" },
        ...
        { pattern: "\\b0([0-9])\\. (?=Januar|Februar|März|April|Mai|Juni|Juli|August|September|Oktober|November|Dezember)", flags: "gu", replacement: "$(1). " },
...
(function(){
 'use strict';
 console.log('[SuperRED] 4.2.12 geladen @', location.href);
...
console.log('SuperMAX 4.2.12 bereit.'); console.info('[SuperMAX] formatting-preserve: ON');
